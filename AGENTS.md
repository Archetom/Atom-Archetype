...
Spring Boot 4.1, Java 25, MyBatis-Plus 3.5.17, MySQL 26.7.0 in Docker Compose, Flyway, optional Redis 8.10.0 (Lettuce), MapStruct 1.6.3, Lombok, SpringDoc OpenAPI 3.1.0, and Testcontainers. Core result/error dependency: `io.github.archetom:atom-common:1.0.1`.
