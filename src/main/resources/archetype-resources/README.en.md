...
A production-oriented Java 25 and Spring Boot 4.1 multi-module starter for Domain-Driven Design (DDD), hexagonal boundaries, explicit multi-tenancy, MyBatis-Plus, MySQL, Flyway, and optional Redis caching.
...
- JDK 25
- Bundled Maven Wrapper (Maven 3.9.16)
